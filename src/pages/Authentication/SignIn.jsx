...
//     return (
//       <div className={`fixed top-4 inset-x-0 max-w-sm mx-auto p-4 rounded-lg border-l-4 ${bgColor} shadow-md z-50 animate-fade-in-down md:top-6 md:right-6 md:mx-0 md:inset-x-auto md:right-6`}>        <div className="flex items-start">
