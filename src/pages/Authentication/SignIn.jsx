...
//   const [password, setPassword] = useState('kjyFlPEq');
...
//       console.log(response); //  response.data.payload - id : set at localstorage
//       localStorage.setItem("builder-id", JSON.stringify(response.data.payload))

//       // You can redirect after successful login
...
const SignIn = () => {
  ...
  const Notification = () => {
    ...
    return (
      <div className={`fixed top-4 right-4 max-w-sm mx-auto p-4 rounded-lg border-l-4 ${bgColor} shadow-md z-50 animate-fade-in-down md:top-6 md:right-6`}>
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col md:flex-row rounded-sm border border-stroke bg-white shadow-lg dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="w-full md:w-1/2 p-4 sm:p-8 md:p-12 flex items-center justify-center">
