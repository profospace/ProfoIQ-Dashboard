...
const ProjectsInteractions = () => {
  ...
  // Filter activities by date
  const filterActivitiesByDate = (projectId, date) => {
    if (!date) {
  ...
  const handleProjectSelect = (projectId) => {
    setSelectedProjectId(projectId);
    fetchProjectInteractions(projectId);
    // Reset date filter when changing projects
            ...
            <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
              ...
              <div className="flex space-x-2 items-center">
                ...
                <button
                  ref={dateButtonRef}
                  onClick={toggleCalendar}
                  className="flex items-center px-4 py-2 bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-lg text-sm font-medium hover:bg-purple-100 dark:hover:bg-purple-900/50 transition-colors"
                >
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
              ...
              <div>
                ...
                <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="flex items-center">
                    {isDateFiltered ? (
                      <div className="bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 px-3 py-1 rounded-full text-xs flex items-center">
                        <span>Filtered by: {format(selectedDate, 'MMM d, yyyy')}</span>
                        <button
                          onClick={clearDateFilter}
                          className="ml-2 text-purple-700 dark:text-purple-300 hover:text-purple-900 dark:hover:text-purple-100 focus:outline-none"
                        >
